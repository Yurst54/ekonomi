...
module.exports = client => {
  ...
  client.user.setGame(`Hero Coding` + client.guilds.size + ` Sunucu ve ` + client.guilds.reduce((a, b) => a + b.memberCount, 0).toLocaleString() + ` Kullanıcı!`, 'https://www.twitch.tv/nefarious_ata');
